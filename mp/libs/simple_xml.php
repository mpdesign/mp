 ...
 * 简易xml库处理类
 +----------------------------------------------------------------------+
 * Copyright (c) 2006-2012 http://www.737.com/ All rights reserved.
 +----------------------------------------------------------------------+
 * Author: xiefg <fugen.xie@qq.com>
 +----------------------------------------------------------------------+
 * $Id: simple_xml.php 2013-8-1 737 $
 +----------------------------------------------------------------------+
 */

class simple_xml_lib
{   
	var $result = array();
	var $ignore_level = 0;
...
// end simple_xml_lib class

/* end of file simple_xml.php */
/* location: ./mp/libs/simple_xml.php */